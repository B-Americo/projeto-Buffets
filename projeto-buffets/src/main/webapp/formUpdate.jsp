		...
		<div class="cold-md-7">
			...
			<form action="clienteAtualizar" method="POST">
				...
				<div class="form-floating mb-3">
						...
						<input name="qtdConvidados" value="${cliente.qtdConvidados}" maxlength="11" type="number" class="form-control" onkeypress="return event.charCode >= 48 && event.charCode <= 57"> 
